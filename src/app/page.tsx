  ...
  const { isLoading, error, data, refetch } = useQuery<WeatherData>(
    ...
    async () => {
      const { data } = await axios.get(
        `https://api.openweathermap.org/data/2.5/forecast?q=${place}&appid=2b660f3d770fb56c009ea86561f9495c&cnt=56`
      );
      return data;
    }
  );
          ...
          <>
            <section className="space-y-4 ">
              ...
              <div className=" flex gap-4">
                {/* left  */}
                <Container className="w-fit  justify-center flex-col px-4 items-center bg-gray-400/40 ">
                ...
                <Container className="bg-orange-500/80  px-6 gap-4 justify-between overflow-x-auto">
                  <WeatherDetails
